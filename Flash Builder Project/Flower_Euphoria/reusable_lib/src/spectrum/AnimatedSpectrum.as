package spectrum
{
	 ...
	 */
	public class AnimatedSpectrum extends Sprite 
	{
		//statics
		private static const MUSIC_PATH:String = "music.mp3";
		...
		private function onSoundEnterFrame(e:Event):void
		{
			updateGraphics();
			updateBitmap();
			_centerSprite.x += (mouseX - _centerSprite.x) / 5;
			_centerSprite.y += (mouseY - _centerSprite.y) / 5;
		}
